 ...
 */
final class Version20230522112234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rate (id INT NOT NULL, author_id INT DEFAULT NULL, product_id INT NOT NULL, mark INT NOT NULL, PRIMARY KEY(id))');
